...
#{{{
    ...
    def get_extra_ber(self, nBit, ln_i):
        ...
        countnum = 29
        filename = self.mCfg.dump_abs_path + "histo_data_" + "ln" + str(ln_i) + "_count" + str(countnum) + ".txt"
