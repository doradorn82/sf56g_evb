	...
	def GetHistogram(self):
		...
		for ln_i in range(4):
			if self.is_lane_enabled(ln_i):
				...
				filename = self.dump_path+"histo_data_" + self.mCfg.GetCondition()+ "_ln" + str(ln_i) + "_count2^" + str(countnum)+ ".txt"
				fs = open(filename, 'w')
