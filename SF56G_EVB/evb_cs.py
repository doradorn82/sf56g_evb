...
class EVB_CS(object):
    def __init__(self):
        ...
        self.func_record = {'phyExtClkEn':0,   'phyExtClkEn_pcs':0,   'phyXoClkEn':0,   'SwCm1Adap':0,   'CheckOverGainAdc':0,   'CheckOverGainCal':0,   'txSlbBistEn':0,   'txElbBistEn':0,   'rxSlbBistEn':0,   'rxElbBistEn':0,   'WriteInitialRxEvalVector':0,   'WritePostRxEvalVector':0,   'AfeAdaptation':0,   'AfeTuneScale':0,   'AdcFineCalRestart':0,   'SwVga2Adap':0,   'SwOffsetCompensationCh':0,   'writeLaneDefault25gVector':0,   'WriteCmnVector':0,   'phyEqC1Forcing':0,   'phyEqCpre1Forcing':0,   'phyEqOff':0,   'phyEqOff4to8':0,   'txRemoteLbEn':0,   'gbe_1x200g_pcs_config':0,   'gbe_1x100g_pcs_config':0,   'gbe_1x25g_pcs_config':0,   'gbe_1x40g_pcs_config':0,   'WriteSlbVector':0,   'SweepGetBer':0,   'WriteElbVector':0,   'WriteElbVector_pcs_lb':0,   'WriteSineElbVector':0,   'WriteRxEvalVector':0,   'PCS_loopback':0,   'PCS_200gx1_loopback':0,   'PCS_100gx1_loopback':0,   'PCS_25gx1_loopback':0,   'PCS_40gx1_loopback':0,   'WriteProtlbVector':0,   'DefaultFfeWrite':0,   'TxSineOut':0,   'get_histogram':0,   'GetAllChHistogram':0,   'GetHistoEom':0,   'GetBerEom':0,   'GetBerEomPam4':0,   'GetBathtub':0,   'getHorizontalCenter':0,   'GetBer':0,   'Plot256':0,   'C1SweepAdap':0,   'Cm1SweepAdap':0,   'C1CtrlSweep':0,   'GetCaloutMin':0,   'GetCaloutMax':0,   'GetAdcMaxMin':0,   'GetCalMaxMin':0,   'GetAdcMin8':0,   'GetAdcMax8':0,   'GetAdcMaxMin8':0,   'GetAdcMin':0,   'GetAdcMax':0,   'VcoCharac':0,   'get_histogramOfBer':0}
    ...
    def TxSineOut(self, freq=3):
        ...
        for ln_i in range(4):
            if self.is_lane_enabled(ln_i):
                ...
                for i in range(256):
                    if (freq == 3):
                        if (i == 0): self.mApb.write(0x00051000 + i * 4, 0x7f, ln_i)
                        elif (i == 1): self.mApb.write(0x00051000 + i * 4, 0x88, ln_i)
                        elif (i == 2): self.mApb.write(0x00051000 + i * 4, 0x92, ln_i)
                        elif (i == 3): self.mApb.write(0x00051000 + i * 4, 0x9b, ln_i)
                        elif (i == 4): self.mApb.write(0x00051000 + i * 4, 0xa4, ln_i)
                        elif (i == 5): self.mApb.write(0x00051000 + i * 4, 0xad, ln_i)
                        elif (i == 6): self.mApb.write(0x00051000 + i * 4, 0xb5, ln_i)
                        elif (i == 7): self.mApb.write(0x00051000 + i * 4, 0xbe, ln_i)
                        elif (i == 8): self.mApb.write(0x00051000 + i * 4, 0xc6, ln_i)
                        elif (i == 9): self.mApb.write(0x00051000 + i * 4, 0xcd, ln_i)
                        elif (i == 10): self.mApb.write(0x00051000 + i * 4, 0xd5, ln_i)
                        elif (i == 11): self.mApb.write(0x00051000 + i * 4, 0xdb, ln_i)
                        elif (i == 12): self.mApb.write(0x00051000 + i * 4, 0xe1, ln_i)
                        elif (i == 13): self.mApb.write(0x00051000 + i * 4, 0xe7, ln_i)
                        elif (i == 14): self.mApb.write(0x00051000 + i * 4, 0xec, ln_i)
                        elif (i == 15): self.mApb.write(0x00051000 + i * 4, 0xf1, ln_i)
                        elif (i == 16): self.mApb.write(0x00051000 + i * 4, 0xf5, ln_i)
                        elif (i == 17): self.mApb.write(0x00051000 + i * 4, 0xf8, ln_i)
                        elif (i == 18): self.mApb.write(0x00051000 + i * 4, 0xfa, ln_i)
                        elif (i == 19): self.mApb.write(0x00051000 + i * 4, 0xfc, ln_i)
                        elif (i == 20): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 21): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 22): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 23): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 24): self.mApb.write(0x00051000 + i * 4, 0xfb, ln_i)
                        elif (i == 25): self.mApb.write(0x00051000 + i * 4, 0xf9, ln_i)
                        elif (i == 26): self.mApb.write(0x00051000 + i * 4, 0xf6, ln_i)
                        elif (i == 27): self.mApb.write(0x00051000 + i * 4, 0xf3, ln_i)
                        elif (i == 28): self.mApb.write(0x00051000 + i * 4, 0xef, ln_i)
                        elif (i == 29): self.mApb.write(0x00051000 + i * 4, 0xea, ln_i)
                        elif (i == 30): self.mApb.write(0x00051000 + i * 4, 0xe4, ln_i)
                        elif (i == 31): self.mApb.write(0x00051000 + i * 4, 0xde, ln_i)
                        elif (i == 32): self.mApb.write(0x00051000 + i * 4, 0xd8, ln_i)
                        elif (i == 33): self.mApb.write(0x00051000 + i * 4, 0xd1, ln_i)
                        elif (i == 34): self.mApb.write(0x00051000 + i * 4, 0xca, ln_i)
                        elif (i == 35): self.mApb.write(0x00051000 + i * 4, 0xc2, ln_i)
                        elif (i == 36): self.mApb.write(0x00051000 + i * 4, 0xba, ln_i)
                        elif (i == 37): self.mApb.write(0x00051000 + i * 4, 0xb1, ln_i)
                        elif (i == 38): self.mApb.write(0x00051000 + i * 4, 0xa8, ln_i)
                        elif (i == 39): self.mApb.write(0x00051000 + i * 4, 0x9f, ln_i)
                        elif (i == 40): self.mApb.write(0x00051000 + i * 4, 0x96, ln_i)
                        elif (i == 41): self.mApb.write(0x00051000 + i * 4, 0x8d, ln_i)
                        elif (i == 42): self.mApb.write(0x00051000 + i * 4, 0x84, ln_i)
                        elif (i == 43): self.mApb.write(0x00051000 + i * 4, 0x7a, ln_i)
                        elif (i == 44): self.mApb.write(0x00051000 + i * 4, 0x71, ln_i)
                        elif (i == 45): self.mApb.write(0x00051000 + i * 4, 0x68, ln_i)
                        elif (i == 46): self.mApb.write(0x00051000 + i * 4, 0x5f, ln_i)
                        elif (i == 47): self.mApb.write(0x00051000 + i * 4, 0x56, ln_i)
                        elif (i == 48): self.mApb.write(0x00051000 + i * 4, 0x4d, ln_i)
                        elif (i == 49): self.mApb.write(0x00051000 + i * 4, 0x44, ln_i)
                        elif (i == 50): self.mApb.write(0x00051000 + i * 4, 0x3c, ln_i)
                        elif (i == 51): self.mApb.write(0x00051000 + i * 4, 0x34, ln_i)
                        elif (i == 52): self.mApb.write(0x00051000 + i * 4, 0x2d, ln_i)
                        elif (i == 53): self.mApb.write(0x00051000 + i * 4, 0x26, ln_i)
                        elif (i == 54): self.mApb.write(0x00051000 + i * 4, 0x20, ln_i)
                        elif (i == 55): self.mApb.write(0x00051000 + i * 4, 0x1a, ln_i)
                        elif (i == 56): self.mApb.write(0x00051000 + i * 4, 0x14, ln_i)
                        elif (i == 57): self.mApb.write(0x00051000 + i * 4, 0xf, ln_i)
                        elif (i == 58): self.mApb.write(0x00051000 + i * 4, 0xb, ln_i)
                        elif (i == 59): self.mApb.write(0x00051000 + i * 4, 0x8, ln_i)
                        elif (i == 60): self.mApb.write(0x00051000 + i * 4, 0x5, ln_i)
                        elif (i == 61): self.mApb.write(0x00051000 + i * 4, 0x3, ln_i)
                        elif (i == 62): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 63): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 64): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 65): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 66): self.mApb.write(0x00051000 + i * 4, 0x2, ln_i)
                        elif (i == 67): self.mApb.write(0x00051000 + i * 4, 0x4, ln_i)
                        elif (i == 68): self.mApb.write(0x00051000 + i * 4 + 1, 0x6, ln_i)
                        elif (i == 69): self.mApb.write(0x00051000 + i * 4, 0x9, ln_i)
                        elif (i == 70): self.mApb.write(0x00051000 + i * 4, 0xd, ln_i)
                        elif (i == 71): self.mApb.write(0x00051000 + i * 4, 0x12, ln_i)
                        elif (i == 72): self.mApb.write(0x00051000 + i * 4, 0x17, ln_i)
                        elif (i == 73): self.mApb.write(0x00051000 + i * 4, 0x1d, ln_i)
                        elif (i == 74): self.mApb.write(0x00051000 + i * 4, 0x23, ln_i)
                        elif (i == 75): self.mApb.write(0x00051000 + i * 4, 0x29, ln_i)
                        elif (i == 76): self.mApb.write(0x00051000 + i * 4, 0x31, ln_i)
                        elif (i == 77): self.mApb.write(0x00051000 + i * 4, 0x38, ln_i)
                        elif (i == 78): self.mApb.write(0x00051000 + i * 4, 0x40, ln_i)
                        elif (i == 79): self.mApb.write(0x00051000 + i * 4, 0x49, ln_i)
                        elif (i == 80): self.mApb.write(0x00051000 + i * 4, 0x51, ln_i)
                        elif (i == 81): self.mApb.write(0x00051000 + i * 4, 0x5a, ln_i)
                        elif (i == 82): self.mApb.write(0x00051000 + i * 4, 0x63, ln_i)
                        elif (i == 83): self.mApb.write(0x00051000 + i * 4, 0x6c, ln_i)
                        elif (i == 84): self.mApb.write(0x00051000 + i * 4, 0x76, ln_i)
                        elif (i == 85): self.mApb.write(0x00051000 + i * 4, 0x7f, ln_i)
                        elif (i == 86): self.mApb.write(0x00051000 + i * 4, 0x88, ln_i)
                        elif (i == 87): self.mApb.write(0x00051000 + i * 4, 0x92, ln_i)
                        elif (i == 88): self.mApb.write(0x00051000 + i * 4, 0x9b, ln_i)
                        elif (i == 89): self.mApb.write(0x00051000 + i * 4, 0xa4, ln_i)
                        elif (i == 90): self.mApb.write(0x00051000 + i * 4, 0xad, ln_i)
                        elif (i == 91): self.mApb.write(0x00051000 + i * 4, 0xb5, ln_i)
                        elif (i == 92): self.mApb.write(0x00051000 + i * 4, 0xbe, ln_i)
                        elif (i == 93): self.mApb.write(0x00051000 + i * 4, 0xc6, ln_i)
                        elif (i == 94): self.mApb.write(0x00051000 + i * 4, 0xcd, ln_i)
                        elif (i == 95): self.mApb.write(0x00051000 + i * 4, 0xd5, ln_i)
                        elif (i == 96): self.mApb.write(0x00051000 + i * 4, 0xdb, ln_i)
                        elif (i == 97): self.mApb.write(0x00051000 + i * 4, 0xe1, ln_i)
                        elif (i == 98): self.mApb.write(0x00051000 + i * 4, 0xe7, ln_i)
                        elif (i == 99): self.mApb.write(0x00051000 + i * 4, 0xec, ln_i)
                        elif (i == 100): self.mApb.write(0x00051000 + i * 4, 0xf1, ln_i)
                        elif (i == 101): self.mApb.write(0x00051000 + i * 4, 0xf5, ln_i)
                        elif (i == 102): self.mApb.write(0x00051000 + i * 4, 0xf8, ln_i)
                        elif (i == 103): self.mApb.write(0x00051000 + i * 4, 0xfa, ln_i)
                        elif (i == 104): self.mApb.write(0x00051000 + i * 4, 0xfc, ln_i)
                        elif (i == 105): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 106): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 107): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 108): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 109): self.mApb.write(0x00051000 + i * 4, 0xfb, ln_i)
                        elif (i == 110): self.mApb.write(0x00051000 + i * 4, 0xf9, ln_i)
                        elif (i == 111): self.mApb.write(0x00051000 + i * 4, 0xf6, ln_i)
                        elif (i == 112): self.mApb.write(0x00051000 + i * 4, 0xf3, ln_i)
                        elif (i == 113): self.mApb.write(0x00051000 + i * 4, 0xef, ln_i)
                        elif (i == 114): self.mApb.write(0x00051000 + i * 4, 0xea, ln_i)
                        elif (i == 115): self.mApb.write(0x00051000 + i * 4, 0xe4, ln_i)
                        elif (i == 116): self.mApb.write(0x00051000 + i * 4, 0xde, ln_i)
                        elif (i == 117): self.mApb.write(0x00051000 + i * 4, 0xd8, ln_i)
                        elif (i == 118): self.mApb.write(0x00051000 + i * 4, 0xd1, ln_i)
                        elif (i == 119): self.mApb.write(0x00051000 + i * 4, 0xca, ln_i)
                        elif (i == 120): self.mApb.write(0x00051000 + i * 4, 0xc2, ln_i)
                        elif (i == 121): self.mApb.write(0x00051000 + i * 4, 0xba, ln_i)
                        elif (i == 122): self.mApb.write(0x00051000 + i * 4, 0xb1, ln_i)
                        elif (i == 123): self.mApb.write(0x00051000 + i * 4, 0xa8, ln_i)
                        elif (i == 124): self.mApb.write(0x00051000 + i * 4, 0x9f, ln_i)
                        elif (i == 125): self.mApb.write(0x00051000 + i * 4, 0x96, ln_i)
                        elif (i == 126): self.mApb.write(0x00051000 + i * 4, 0x8d, ln_i)
                        elif (i == 127): self.mApb.write(0x00051000 + i * 4, 0x84, ln_i)
                        elif (i == 128): self.mApb.write(0x00051000 + i * 4, 0x7a, ln_i)
                        elif (i == 129): self.mApb.write(0x00051000 + i * 4, 0x71, ln_i)
                        elif (i == 130): self.mApb.write(0x00051000 + i * 4, 0x68, ln_i)
                        elif (i == 131): self.mApb.write(0x00051000 + i * 4, 0x5f, ln_i)
                        elif (i == 132): self.mApb.write(0x00051000 + i * 4 + 2, 0x56, ln_i)
                        elif (i == 133): self.mApb.write(0x00051000 + i * 4, 0x4d, ln_i)
                        elif (i == 134): self.mApb.write(0x00051000 + i * 4, 0x44, ln_i)
                        elif (i == 135): self.mApb.write(0x00051000 + i * 4, 0x3c, ln_i)
                        elif (i == 136): self.mApb.write(0x00051000 + i * 4, 0x34, ln_i)
                        elif (i == 137): self.mApb.write(0x00051000 + i * 4, 0x2d, ln_i)
                        elif (i == 138): self.mApb.write(0x00051000 + i * 4, 0x26, ln_i)
                        elif (i == 139): self.mApb.write(0x00051000 + i * 4, 0x20, ln_i)
                        elif (i == 140): self.mApb.write(0x00051000 + i * 4, 0x1a, ln_i)
                        elif (i == 141): self.mApb.write(0x00051000 + i * 4, 0x14, ln_i)
                        elif (i == 142): self.mApb.write(0x00051000 + i * 4, 0xf, ln_i)
                        elif (i == 143): self.mApb.write(0x00051000 + i * 4, 0xb, ln_i)
                        elif (i == 144): self.mApb.write(0x00051000 + i * 4, 0x8, ln_i)
                        elif (i == 145): self.mApb.write(0x00051000 + i * 4, 0x5, ln_i)
                        elif (i == 146): self.mApb.write(0x00051000 + i * 4, 0x3, ln_i)
                        elif (i == 147): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 148): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 149): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 150): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 151): self.mApb.write(0x00051000 + i * 4, 0x2, ln_i)
                        elif (i == 152): self.mApb.write(0x00051000 + i * 4, 0x4, ln_i)
                        elif (i == 153): self.mApb.write(0x00051000 + i * 4, 0x6, ln_i)
                        elif (i == 154): self.mApb.write(0x00051000 + i * 4, 0x9, ln_i)
                        elif (i == 155): self.mApb.write(0x00051000 + i * 4, 0xd, ln_i)
                        elif (i == 156): self.mApb.write(0x00051000 + i * 4, 0x12, ln_i)
                        elif (i == 157): self.mApb.write(0x00051000 + i * 4, 0x17, ln_i)
                        elif (i == 158): self.mApb.write(0x00051000 + i * 4, 0x1d, ln_i)
                        elif (i == 159): self.mApb.write(0x00051000 + i * 4, 0x23, ln_i)
                        elif (i == 160): self.mApb.write(0x00051000 + i * 4, 0x29, ln_i)
                        elif (i == 161): self.mApb.write(0x00051000 + i * 4, 0x31, ln_i)
                        elif (i == 162): self.mApb.write(0x00051000 + i * 4, 0x38, ln_i)
                        elif (i == 163): self.mApb.write(0x00051000 + i * 4, 0x40, ln_i)
                        elif (i == 164): self.mApb.write(0x00051000 + i * 4, 0x49, ln_i)
                        elif (i == 165): self.mApb.write(0x00051000 + i * 4, 0x51, ln_i)
                        elif (i == 166): self.mApb.write(0x00051000 + i * 4, 0x5a, ln_i)
                        elif (i == 167): self.mApb.write(0x00051000 + i * 4, 0x63, ln_i)
                        elif (i == 168): self.mApb.write(0x00051000 + i * 4, 0x6c, ln_i)
                        elif (i == 169): self.mApb.write(0x00051000 + i * 4, 0x76, ln_i)
                        elif (i == 170): self.mApb.write(0x00051000 + i * 4, 0x7f, ln_i)
                        elif (i == 171): self.mApb.write(0x00051000 + i * 4, 0x88, ln_i)
                        elif (i == 172): self.mApb.write(0x00051000 + i * 4, 0x92, ln_i)
                        elif (i == 173): self.mApb.write(0x00051000 + i * 4, 0x9b, ln_i)
                        elif (i == 174): self.mApb.write(0x00051000 + i * 4, 0xa4, ln_i)
                        elif (i == 175): self.mApb.write(0x00051000 + i * 4, 0xad, ln_i)
                        elif (i == 176): self.mApb.write(0x00051000 + i * 4, 0xb5, ln_i)
                        elif (i == 177): self.mApb.write(0x00051000 + i * 4, 0xbe, ln_i)
                        elif (i == 178): self.mApb.write(0x00051000 + i * 4, 0xc6, ln_i)
                        elif (i == 179): self.mApb.write(0x00051000 + i * 4, 0xcd, ln_i)
                        elif (i == 180): self.mApb.write(0x00051000 + i * 4, 0xd5, ln_i)
                        elif (i == 181): self.mApb.write(0x00051000 + i * 4, 0xdb, ln_i)
                        elif (i == 182): self.mApb.write(0x00051000 + i * 4, 0xe1, ln_i)
                        elif (i == 183): self.mApb.write(0x00051000 + i * 4, 0xe7, ln_i)
                        elif (i == 184): self.mApb.write(0x00051000 + i * 4, 0xec, ln_i)
                        elif (i == 185): self.mApb.write(0x00051000 + i * 4, 0xf1, ln_i)
                        elif (i == 186): self.mApb.write(0x00051000 + i * 4, 0xf5, ln_i)
                        elif (i == 187): self.mApb.write(0x00051000 + i * 4, 0xf8, ln_i)
                        elif (i == 188): self.mApb.write(0x00051000 + i * 4, 0xfa, ln_i)
                        elif (i == 189): self.mApb.write(0x00051000 + i * 4, 0xfc, ln_i)
                        elif (i == 190): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 191): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 192): self.mApb.write(0x00051000 + i * 4, 0xfe, ln_i)
                        elif (i == 193): self.mApb.write(0x00051000 + i * 4, 0xfd, ln_i)
                        elif (i == 194): self.mApb.write(0x00051000 + i * 4, 0xfb, ln_i)
                        elif (i == 195): self.mApb.write(0x00051000 + i * 4, 0xf9, ln_i)
                        elif (i == 196): self.mApb.write(0x00051000 + i * 4, 0xf6, ln_i)
                        elif (i == 197): self.mApb.write(0x00051000 + i * 4, 0xf3, ln_i)
                        elif (i == 198): self.mApb.write(0x00051000 + i * 4, 0xef, ln_i)
                        elif (i == 199): self.mApb.write(0x00051000 + i * 4, 0xea, ln_i)
                        elif (i == 200): self.mApb.write(0x00051000 + i * 4, 0xe4, ln_i)
                        elif (i == 201): self.mApb.write(0x00051000 + i * 4, 0xde, ln_i)
                        elif (i == 202): self.mApb.write(0x00051000 + i * 4, 0xd8, ln_i)
                        elif (i == 203): self.mApb.write(0x00051000 + i * 4, 0xd1, ln_i)
                        elif (i == 204): self.mApb.write(0x00051000 + i * 4, 0xca, ln_i)
                        elif (i == 205): self.mApb.write(0x00051000 + i * 4, 0xc2, ln_i)
                        elif (i == 206): self.mApb.write(0x00051000 + i * 4, 0xba, ln_i)
                        elif (i == 207): self.mApb.write(0x00051000 + i * 4, 0xb1, ln_i)
                        elif (i == 208): self.mApb.write(0x00051000 + i * 4, 0xa8, ln_i)
                        elif (i == 209): self.mApb.write(0x00051000 + i * 4, 0x9f, ln_i)
                        elif (i == 210): self.mApb.write(0x00051000 + i * 4, 0x96, ln_i)
                        elif (i == 211): self.mApb.write(0x00051000 + i * 4, 0x8d, ln_i)
                        elif (i == 212): self.mApb.write(0x00051000 + i * 4, 0x84, ln_i)
                        elif (i == 213): self.mApb.write(0x00051000 + i * 4, 0x7a, ln_i)
                        elif (i == 214): self.mApb.write(0x00051000 + i * 4, 0x71, ln_i)
                        elif (i == 215): self.mApb.write(0x00051000 + i * 4, 0x68, ln_i)
                        elif (i == 216): self.mApb.write(0x00051000 + i * 4, 0x5f, ln_i)
                        elif (i == 217): self.mApb.write(0x00051000 + i * 4, 0x56, ln_i)
                        elif (i == 218): self.mApb.write(0x00051000 + i * 4, 0x4d, ln_i)
                        elif (i == 219): self.mApb.write(0x00051000 + i * 4, 0x44, ln_i)
                        elif (i == 220): self.mApb.write(0x00051000 + i * 4, 0x3c, ln_i)
                        elif (i == 221): self.mApb.write(0x00051000 + i * 4, 0x34, ln_i)
                        elif (i == 222): self.mApb.write(0x00051000 + i * 4, 0x2d, ln_i)
                        elif (i == 223): self.mApb.write(0x00051000 + i * 4, 0x26, ln_i)
                        elif (i == 224): self.mApb.write(0x00051000 + i * 4, 0x20, ln_i)
                        elif (i == 225): self.mApb.write(0x00051000 + i * 4, 0x1a, ln_i)
                        elif (i == 226): self.mApb.write(0x00051000 + i * 4, 0x14, ln_i)
                        elif (i == 227): self.mApb.write(0x00051000 + i * 4, 0xf, ln_i)
                        elif (i == 228): self.mApb.write(0x00051000 + i * 4, 0xb, ln_i)
                        elif (i == 229): self.mApb.write(0x00051000 + i * 4, 0x8, ln_i)
                        elif (i == 230): self.mApb.write(0x00051000 + i * 4, 0x5, ln_i)
                        elif (i == 231): self.mApb.write(0x00051000 + i * 4, 0x3, ln_i)
                        elif (i == 232): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 233): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 234): self.mApb.write(0x00051000 + i * 4, 0x0, ln_i)
                        elif (i == 235): self.mApb.write(0x00051000 + i * 4, 0x1, ln_i)
                        elif (i == 236): self.mApb.write(0x00051000 + i * 4, 0x2, ln_i)
                        elif (i == 237): self.mApb.write(0x00051000 + i * 4, 0x4, ln_i)
                        elif (i == 238): self.mApb.write(0x00051000 + i * 4, 0x6, ln_i)
                        elif (i == 239): self.mApb.write(0x00051000 + i * 4, 0x9, ln_i)
                        elif (i == 240): self.mApb.write(0x00051000 + i * 4, 0xd, ln_i)
                        elif (i == 241): self.mApb.write(0x00051000 + i * 4, 0x12, ln_i)
                        elif (i == 242): self.mApb.write(0x00051000 + i * 4, 0x17, ln_i)
                        elif (i == 243): self.mApb.write(0x00051000 + i * 4, 0x1d, ln_i)
                        elif (i == 244): self.mApb.write(0x00051000 + i * 4, 0x23, ln_i)
                        elif (i == 245): self.mApb.write(0x00051000 + i * 4, 0x29, ln_i)
                        elif (i == 246): self.mApb.write(0x00051000 + i * 4, 0x31, ln_i)
                        elif (i == 247): self.mApb.write(0x00051000 + i * 4, 0x38, ln_i)
                        elif (i == 248): self.mApb.write(0x00051000 + i * 4, 0x40, ln_i)
                        elif (i == 249): self.mApb.write(0x00051000 + i * 4, 0x49, ln_i)
                        elif (i == 250): self.mApb.write(0x00051000 + i * 4, 0x51, ln_i)
                        elif (i == 251): self.mApb.write(0x00051000 + i * 4, 0x5a, ln_i)
                        elif (i == 252): self.mApb.write(0x00051000 + i * 4, 0x63, ln_i)
                        elif (i == 253): self.mApb.write(0x00051000 + i * 4, 0x6c, ln_i)
                        elif (i == 254): self.mApb.write(0x00051000 + i * 4, 0x76, ln_i)
#----------------------------------------------------------------------------------------------------
# Test Item
#----------------------------------------------------------------------------------------------------
    def get_histogram(self,ln_i):
        self.func_record['get_histogram'] +=1
        memSize = 128
        ...
        countnum = (self.mApb.read(0x00061000 ,ln_i)&0x7f) >> 3
        countnum += 14
        filename = self.dump_path+"histo_data_" + "ln" + str(ln_i) + "_count" + str(countnum)+ ".txt"
        fs = open(filename, 'w')
    ...
    def get_extra_ber(self,nBit,ln_i):
        ...
        fs.close()
        if(nBit==2):
            return bathtub_extrapolation_pam4(filename,countnum)
        else:
            return bathtub_extrapolation_nrz(filename,countnum)
        ...
        for ln_i in range(4):
            if self.is_lane_enabled(ln_i):
                ...
                for eq_i in range(62):
                    ...
                    print("%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%e\t%d\t"%(StartCode - eq_i, -cm2, -cm1, c0, -c1, -c2, -c3, -c4, -c5, -c6, -c7, -c8,  ber, c1MinusCm1))
                fs.close()
                plot_coeff(filename)
        print("Sweep Done!")
        return 0
    ...
    def get_histogramOfBer(self,filename):
        self.func_record['get_histogramOfBer'] +=1
        memSize = 128;
        for ln_i in range(4):
                if self.is_lane_enabled(ln_i):
